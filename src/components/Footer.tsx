...
import cert1 from '../assets/images/cert_iso_14001_trans.png';
import cert2 from '../assets/images/cert_iso_9001_trans.png';
import cert3 from '../assets/images/cert_iso_45001_trans.png';
import cert4 from '../assets/images/cert_icv_trans.png';
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-row flex-nowrap items-center justify-start gap-[0px] mt-4 w-full -ml-4 sm:-ml-8">
              <img src={cert1} alt="ISO 14001" className="h-16 sm:h-24 w-auto object-contain flex-shrink-0 -mr-6 sm:-mr-12" style={{ clipPath: 'polygon(0 0, 96% 0, 96% 96%, 0 96%)' }} />
              <img src={cert2} alt="ISO 9001" className="h-16 sm:h-24 w-auto object-contain flex-shrink-0 -mr-6 sm:-mr-12" style={{ clipPath: 'polygon(0 0, 96% 0, 96% 96%, 0 96%)' }} />
